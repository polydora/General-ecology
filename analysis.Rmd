...
test_lecture_6 <- read_xlsx("data/Тест по теме Взаимоотношения организмов (Ответы Биологи 2025).xlsx")
...
test_lecture_7 <- read_xlsx("data/Тест по теме Взаимоотношения организмов (Ответы Биологи 2025).xlsx")
...
credits_print$Sum <- credits_print %>% 
  select(-c("Login")) %>% 
  rowSums(na.rm=TRUE)
