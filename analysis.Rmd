...
credits_sum <- 10 + 10 + 10 + 10 + 10 + 10 + 8
...
credits_print$Exam <- round(credits_print$Exam, 1) #умножаем на это число, так как от каждой из 8 лекций приходит 10/8 финальной оценки
