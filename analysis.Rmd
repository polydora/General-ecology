...
<!-- cont2 <- read_excel("data/Контрольная работа № 2 (Общая экология для биоинженеров 2023)(1-10).xlsx") -->

<!-- cont2 <- cont2 %>% select(1:3) -->

<!-- names(cont2) <- c("St_Mail",  "Name", "Score") -->

<!-- cont2_print <- merge(class, cont2 %>% select(-Name ), all.x = TRUE ) %>% select(-St_Mail) %>% mutate(Exam = round(Score / 9*3, 1)) -->
