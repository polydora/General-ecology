...
cont1 <- read_excel("data/Контрольная работа № 1 (Общая экология 2024-2025).xlsx")
...
cont1_print <- merge(class, cont1, all.x = T ) %>% select(-St_Mail) %>% mutate(Exam = round(Score / 23 * 1.5, 1) )
