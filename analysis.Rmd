...
Коллеги! В настоящий момент большая часть курса зарегистрировалась в системе Stepik, молодцы! Однако есть несколько человек, которые значатся на курсе, но пока не зарегистрировались. 
...
class_dolg <- class[!complete.cases(class),]

kable(class_dolg[ , 1][complete.cases(class_dolg[ , 1])], col.names = "Ф.И.")
```

Кроме того, обнаружены еще несколько человек, которые не числятся на курсе, но зарегистрировались на Stepik. 
