...
# Тест по Лекции 1
test_lecture_1 <- read_excel("data/Основы ОТС и предмет Экологии (Общая экология 2023)(1-109).xlsx")
...
test_lecture_2 <- read_xlsx("data/Аутэкология (Общая экология 2023)(1-105).xlsx")
