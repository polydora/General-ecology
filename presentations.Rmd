...
## Тeсты для должников (будут открыты до 4 октября)

Внимание! Те, кто уже писал тесты, не смогут пройти их еще раз. При обработке данных будут учитываться только те студенты, которые заявили о своем желании. Вот список
