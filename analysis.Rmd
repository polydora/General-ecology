...
Оценки, которые вы видите на этой страничке, это результат автоматической обработки базы, которую заполняют преподаватели после семинаров.  Проверяйте, пожалуйста, все ваши текущие оценки. Если вы видите, что вам что-то не проставлено, то срочно связывайтесь с соответствующим преподавателем.
...
## **Итоговый счет биологи 2026-2027**
